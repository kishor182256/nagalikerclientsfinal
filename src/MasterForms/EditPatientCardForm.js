...
const EditPatientCardForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    if(data.data){
      toast.success("Patince card Updated")
    }
  };
  ...
  const fetchCard = async (e) => {
    try {
      const data = await axios.get(`${API}/get-patience-card/${id}`, {
        headers: { authtoken: `${TOKEN}` },
      });
          ...
          <div className={classes.formheader}>
            <div className={classes.formname}>
              ...
              <div className={classes.formspecification}>
                You can Edit permanent patients
              </div>
            </div>
            <div>
